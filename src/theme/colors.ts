...
export const baseColors = {
   failure: "#F72B50",
   primary: "#FB075F", // (#bf3745)color of the icons on navbar, scrollbar on right side, fill color of harvest and approve contracts
...
export const lightColors: Colors = {
   ...
   borderColor: "#FB075F", //(#E9EAEB)The small line on the left side, not important
...
export const darkColors: Colors = {
   ...
   textSubtle: "#FFFFFF", //color of text on menu dropdown items
   borderColor: "#FB075F", //(#524B63)The small line on the left side, not important
   card: "#191919",
   gradients: {
