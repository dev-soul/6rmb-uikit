    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$Z, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$$, { color: "currentColor", width: "24px" });
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$Z, { color: "primary" })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$T, { className: "mobile-icon" }),
        React.createElement(Logo$1, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React.createElement(Icon$u, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$v, { width: "24px", color: "textSubtle" }))),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$19, null) : React.createElement(Icon$1a, null)),
    ...
    return (React.createElement(Container, null,
        React.createElement(SettingsEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                ...
                React.createElement(Text, { color: "secondary", bold: true }, "$".concat(cakePriceUsd.toFixed(3))))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$V, { color: "primary", mr: "6px" }),
...
export { Icon$1d as AddIcon, Alert, Icon$1c as ArrowBackIcon, Icon$1b as ArrowDownIcon, Icon$1a as ArrowDropDownIcon, Icon$19 as ArrowDropUpIcon, Icon$18 as ArrowForwardIcon, Icon$z as AuditsIcon, Icon$17 as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$16 as BinanceIcon, Icon$1f as BlockIcon, Breadcrumbs, Icon$15 as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$13 as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$14 as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1h as CheckmarkCircleIcon, Icon$12 as CheckmarkIcon, Icon$11 as ChevronDownIcon, Icon$10 as ChevronLeftIcon, Icon$$ as ChevronRightIcon, Icon$_ as ChevronUpIcon, Icon$Z as CloseIcon, Icon$Y as CogIcon, Icon$X as CommunityIcon, ConnectorNames, Icon$W as CopyIcon, Dropdown, Icon$1g as ErrorIcon, Icon$y as FeaturesIcon, Flex, Heading, Icon$V as HelpIcon, IconButton, Image, Icon$1e as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$U as ListViewIcon, Icon$T as LogoIcon, Icon$S as LogoRoundIcon, Menu, Icon$R as MinusIcon, Modal, ModalProvider, Icon$Q as OpenNewIcon, Icon$O as PancakeRoundIcon, Icon$P as PancakesIcon, Icon$B as PoolsIcon, Icon$N as PrizeIcon, Progress, Icon$K as ProgressBunny, Radio, Icon$A as ReferralsIcon, Icon$M as RemoveIcon, ResetCSS, Icon$G as SearchIcon, Skeleton, Spinner, Svg, Icon$F as SwapVertIcon, Icon$E as SyncAltIcon, Tag, Text, Icon$I as Ticket, Icon$H as TicketRound, Icon$C as TimerIcon, ToastContainer, Toggle, UserBlock, Icon$L as VerifiedIcon, Icon$D as WarningIcon, Icon$J as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
